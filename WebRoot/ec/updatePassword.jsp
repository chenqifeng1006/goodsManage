	...
	<div class="content" style="padding-top: 50px;text-align: center;">
		<div class="login-form" style="top: 5px;">
                <div class="login-box">
                    <div class="mc">
                        <div  class="form">
                            <form id="registForm" action="<%=basePath %>userLogin/userLogin_updatePassword.action" method="post">
                            	<div class="item item-fore1 mt20">
                                    <label class="login-label name-label">原密码</label>
                                    <input id="name" type="text" class="text" name="user.oldPassword"  placeholder="原密码">
                                </div>
                                <div class="item item-fore1 mt20">
                                    <label class="login-label name-label">密码</label>
                                    <input id="name" type="text" class="text" name="user.password"  placeholder="密码">
                                </div>
