	    ...
	    <div class="ec_content">
	    	...
	    	<div class="block">
				...
				<div class="info">
					...
					<div class="author">描述：<%=list.get(i).getDescription()%></div>
					
					<a href="<%=basePath%>shoppingCar/shoppingCar_add.action?commodityid=<%=list.get(i).getId() %>&type=travel&price=<%=list.get(i).getPrice()%>">
