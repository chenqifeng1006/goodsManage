	    ...
	    <div class="ec_content">
	    	...
	    	<div class="block">
				...
				<div class="info">
					...
					<div class="publisher">品牌：<%=list.get(i).getBrand() %></div>				
					<div class="price">价格：￥<%=list.get(i).getPrice() %></div>
					<a href="<%=basePath%>shoppingCar/shoppingCar_add.action?commodityid=<%=list.get(i).getId() %>&type=life&price=<%=list.get(i).getPrice()%>">
