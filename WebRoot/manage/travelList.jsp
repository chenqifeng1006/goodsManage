...
<% 
	...
	String type = "travel";	
	//列表分页的请求的地址
	String listAction = basePath + "travel/travel_query.action";
	//新增数据的请求地址
	String addAction = basePath + "manage/travelAdd.jsp";
	//修改数据的请求地址
	String updateAction = basePath + "travel/travel_update.action";
	//删除数据的请求地址
	String deleteAction = basePath + "travel/travel_delete.action";
	//列表数据
	...
	<div class="content">
		...
		<div class="manageList">
			...
			<div class="listFooter">
				...
				<div class="cut"></div>
				<a <%=currentPage == totalPage ? "href='#'" : "href='" + basePath + "travel/travel_query.action?currentPage=" + (currentPage + 1) + "'" %>>
