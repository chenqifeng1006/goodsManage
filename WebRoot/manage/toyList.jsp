...
<% 
	...
	String type = "toy";	
	//列表分页的请求的地址
	String listAction = basePath + "toy/toy_query.action";
	//新增数据的请求地址
	String addAction = basePath + "manage/toyAdd.jsp";
	//修改数据的请求地址
	String updateAction = basePath + "toy/toy_update.action";
	//删除数据的请求地址
	String deleteAction = basePath + "toy/toy_delete.action";
	//列表数据
