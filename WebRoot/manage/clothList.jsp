...
<% 
	...
	String type = "cloth";	
	//列表分页的请求的地址
	String listAction = basePath + "cloth/cloth_query.action";
	//新增数据的请求地址
	String addAction = basePath + "manage/clothAdd.jsp";
	//修改数据的请求地址
	String updateAction = basePath + "cloth/cloth_update.action";
	//删除数据的请求地址
	String deleteAction = basePath + "cloth/cloth_delete.action";
	//列表数据
	List<Cloth> list=(List<Cloth>)request.getAttribute("list");
%>
	...
	<div class="content">
		...
		<div class="manageList">
			...
			<div class="listFooter">
				...
				<div class="cut"></div>
				<a <%=currentPage == totalPage ? "href='#'" : "href='" + basePath + "cloth/cloth_query.action?currentPage=" + (currentPage + 1) + "'" %>>
