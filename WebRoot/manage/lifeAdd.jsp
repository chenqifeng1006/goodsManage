...
<% 
	...
	String type = "life";	
	//添加的请求地址
	String saveAction = basePath + "life/life_add.action";
	...
	<div class="content">
		...
		<form action="<%=saveAction %>" method="post" enctype="multipart/form-data" name="lifeForm" id="lifeForm">
				...
				<table>
					<tr>
						<td>名称：</td>
						<td><input type="text" name="life.name"/></td>
					</tr>
					<tr>
						<td>颜色：</td>
						<td><input type="text" name="life.color"/></td>
					</tr>
					<tr>
						<td>品牌：</td>
						<td><input type="text" name="life.brand"/></td>
					</tr>
					<tr>
						<td>价格：</td>
						<td><input type="text" name="life.price"/></td>
					</tr>
					<tr>
						<td>图片：</td>
