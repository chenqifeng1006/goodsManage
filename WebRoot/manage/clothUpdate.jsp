...
<% 
	...
	String type = "cloth";	
	//保存的请求地址
	String saveAction = basePath + "cloth/cloth_save.action";
...
<div class="manage_right">
	<div class="content">
		...
		<form action="<%=saveAction %>" method="post" enctype="multipart/form-data" name="clothForm" id="clothForm">
				<input type="hidden" name="cloth.id" value="<%=cloth.getId() %>"/>
				<table>
					<tr>
						<td>名称：</td>
						<td><input type="text" name="cloth.name" value="<%=cloth.getName()%>"/></td>
					</tr>
					<tr>
						<td>颜色：</td>
						<td><input type="text" name="cloth.color"  value="<%=cloth.getColor()%>"/></td>
					</tr>
						<tr>
						<td>品牌：</td>
						<td><input type="text" name="cloth.brand"  value="<%=cloth.getBrand()%>"/></td>
					</tr>
					<tr>
						<td>价格：</td>
						<td><input type="text" name="cloth.price"  value="<%=cloth.getPrice()%>"/></td>
					</tr>
					<tr>
						<td>图片：</td>
