...
public class BorrowGoodsAction extends ActionSupport {
	 


		private static final long serialVersionUID = 1L;
		private BorrowGoods entity;

	    
	  
		public BorrowGoods getEntity() {
			return entity;
		}
		public void setEntity(BorrowGoods entity) {
			this.entity = entity;
		}
	    private int id;
	    ...
	    public String update() {
	        ...
	        BorrowGoods goods =dao.getById(id);
